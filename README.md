...
|----------|---------------|--------------|------------|----------|
| **Activepieces** ⭐ | 1,000 tasks | All features, 2 flows | ✅ Yes | Teams wanting Zapier-like UI |
| **Make** | 1,000 operations | Visual builder, 2 scenarios | ✅ Yes | Visual workflow builders |
| **n8n** (self-hosted) | **Unlimited** | Full features, 500+ integrations | ✅ Yes | Developers, unlimited needs |
| **Huginn** | **Unlimited** | Web scraping specialist | ✅ Yes | Privacy-focused monitoring |
| **Windmill** (self-hosted) | **Unlimited** | Multi-language support | ✅ Yes | Developer workflows |
| **Zapier** | 100 tasks | Industry standard | ❌ No | Beginners testing automation |
| **Pipedream** | ~300 credits | Code-first approach | ✅ Yes | API integrations |
| **Pabbly Connect** | 100 tasks | Unlimited internal steps | ✅ Yes | Complex internal workflows |
| **OttoKit** | 250 tasks | WordPress-focused | ✅ Yes | WordPress users |
| **IFTTT** | 5 applets | 900+ services | ❌ No | Personal/smart home use |
| **Bardeen** | 100 credits | Browser automation | ✅ Yes | Web scraping tasks |
